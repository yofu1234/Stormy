...
public class Forecast {
    ...
    //Copy the code from the getIconId method and paste it here. This way both DailyForecastActivity.java and Current.java can just say "return Forecast.getIconId()" to get the method and we wouldn't have to repeat ourselves
